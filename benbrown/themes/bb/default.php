...
<body>
  <div id="container">
	<header class="top">
		<h1><a href="#">Benjamin Brown</a></h1>
		<nav>
			<ul>
				<li><a href="profile.html">Profile</a></li>
				<li class="active"><a href="/">Creative</a></li>
				<li><a href="#">Notes</a></li>
				<li><a href="mailto:hello@benjaminbrown.co.uk">Contact</a></li>
			</ul>
		</nav>
	</header>
    <div id="descriptive">
		<header class="intro">
			 <?php
   $a = new Area('Strapline');
   $a->display($c);
?>
			
			 <?php
   $a = new Area('Buzzwords');
   $a->display($c);
?>
		</header>
	</div>
	<div id="main-contain">
		<div id="main">
			<ul>
				<li class="post">
					<a href="post.html">
						<img style="background: green" src="#" alt="Blog Post: Title" />
						<details>Green Box</details>
					</a>
				</li>		
				<li class="post">
					<a href="post.html">
						<img style="background: orange" src="#" alt="Blog Post: Title" />
						<details>Orange Box</details>
					</a>
				</li>		
				<li class="post">
					<a href="post.html">
						<img style="background: yellow" src="#" alt="Blog Post: Title" />
						<details>Yellow Box</details>
					</a>
				</li>		
				<li class="post">
					<a href="post.html">
						<img style="background: pink" src="#" alt="Blog Post: Title" />
						<details>Pink Box</details>
					</a>
				</li>					
			</ul>
		</div>
